...
public class RetailApi_V1_MerchantDeviceConfigTest extends RESTEngine{
	...
	//*******  Merchant Retrieve Device Configuration ******//
			...
			public void retriveDeviceConfig(ITestContext context,Hashtable<String, String> data) throws Throwable {
				...
				try {
					if (data.get("RunMode").equals("Y")) {
						MerchantDeviceConfigurationGET.retrieveDeviceConfiguration(data, restActions);
