...
public class NWAPIV2_CustomerContactPassword_NewPasswordIsBlankTest extends NWAPIV2_CustomerBase {
	 ...
	 * 
	 * to try to change an existing password.  The new password is specified as "", in order to
	 * evoke an error message New "Field is blank".
	 * 
	 * testRailId = 1203478
	 * 
	 * @param context
