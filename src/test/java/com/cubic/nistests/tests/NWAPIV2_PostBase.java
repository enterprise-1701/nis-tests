 ...
 *
 */
public abstract class NWAPIV2_PostBase extends RESTEngine {
	...
	protected static final Logger LOG = Logger.getLogger(NWAPIV2_PostBase.class.getName());
	
	/**
	 * The method that calls restActions.postClientResponse.
	 * 
